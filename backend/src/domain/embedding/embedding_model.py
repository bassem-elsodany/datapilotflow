"""
Embedding Model domain models.

This module defines the Pydantic models for embedding model configurations.
"""
...
class EmbeddingModel(BaseModel):
    """Model representing an embedding model configuration."""

    id: str = Field(description="Unique identifier for the embedding model")
    name: str = Field(description="Name of the embedding model")
    endpoint: str = Field(description="API endpoint for the embedding model")
    supported_models: List[str] = Field(description="List of supported model names")
    api_key: str = Field(description="API key for authentication")
    description: Optional[str] = Field(
        default=None, description="Description of the embedding model"
    )
...
class EmbeddingModelCreate(BaseModel):
    """Model for creating a new embedding model configuration."""
...
EmbeddingModelUpdate = EmbeddingModelCreate
