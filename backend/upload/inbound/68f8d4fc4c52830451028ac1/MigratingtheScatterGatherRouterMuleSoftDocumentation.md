...
The payload Scatter-Gather returns is a collection of messages, where each the
result of each route. Those messages are accessible with DataWeave.

## Example

This is a Mule 3 Scatter-Gather with a `custom-aggregation-strategy` element
referencing the Java class with the aggregation strategy:
...
[About Scatter-Gather](scatter-gather-concept)

[About the Transform Component](transform-component-about)

[DataWeave Scripts](../../dataweave/latest/dataweave-language-introduction)
