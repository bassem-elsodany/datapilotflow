...
class ModelProviderService:
    ...
    def create_model_provider(
        ...
        provider_id = self.model_provider_dao.create_model_provider(provider_data, user_id)
        if not provider_id:
    ...
    def update_model_provider(
        ...
        success = self.model_provider_dao.update_model_provider(provider_id, user_id, update_data)
        if not success:
