...
from src.domain.knowledge.job_timeline import JobTimeline, JobTimelineCreate
...
from src.services.knowledge.dao import KnowledgeJobDAO
...
from src.services.knowledge.knowledge_source_service import get_knowledge_source_service
...
class KnowledgeJobService:
    ...
    def create_knowledge_job(
        ...
        if job_data.splitter_id:
            ...
            from src.domain.knowledge.document_splitter import DocumentSplitterCreate
