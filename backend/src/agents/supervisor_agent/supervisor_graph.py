"""
Supervisor Graph using LangGraph for multi-agent orchestration.

This module implements the supervisor agent orchestration using standard
LangGraph patterns for tool-based handoff between RAG and Task agents.
...
def create_supervisor_graph_with_agents(
    ...
    """
    logger.info("🏭 Building Supervisor Graph using LangGraph")
    ...
    async def supervisor_node(state: AgentState) -> Dict[str, Any]:
        ...
        try:
            # Get intent from state if already detected (from _detect_intent)
            # Otherwise, default to rag_only
