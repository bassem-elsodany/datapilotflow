...
class ModelProviderDAO(MongoClientWrapper[ModelProvider]):
    ...
    def create_model_provider(
        ...
        provider_dict = {
            ...
            "embedding": provider_data.embedding.dict() if provider_data.embedding else None,
            "generative": provider_data.generative.dict() if provider_data.generative else None,
        ...
        for field, value in update_data.model_dump(exclude_unset=True).items():
            if value is not None:
                if field in ["embedding", "generative"]:
                    ...
                    update_doc[field] = value.dict() if hasattr(value, 'dict') else value
                else:
    ...
    def get_providers_by_type(
        ...
        return self.list_model_providers(
            user_id, 
