...
In Mule 3, the Secure Properties Placeholder was part of the Security Module.
In Mule 4, it is separated in its own Secure Configuration Properties module.
...
Differences between Mule 3 and Mule 4:
  ...
  * The encryption attributes (`mode` and `algorithm`) are defined in the child tag `<secure-properties:encrypt/>`, and the supported algorithms and modes are the same for both Mule 3 and 4 (see [Mule 4 Secure Configuration Properties](secure-configuration-properties)).
...
[Mule 4 Secure Configuration Properties](secure-configuration-properties)
