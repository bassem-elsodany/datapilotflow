...
from src.services.knowledge.dao import KnowledgeSourceDAO, UrlSourceDAO
...
class KnowledgeSourceService:
    ...
    def get_knowledge_source_config_expanded(
        ...
        if "content_filter" in expand_fields and config.llm_content_filter_id:
            try:
                ...
                from src.services.llm_content_filter.llm_content_filter_service import (
    ...
    def delete_knowledge_source_config(self, config_id: str, user_id: str) -> bool:
        ...
        try:
            ...
            from src.services.knowledge.dao.knowledge_job_dao import KnowledgeJobDAO
